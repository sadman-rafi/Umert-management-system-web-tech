...
<tr><td>  
    ...
    <tr height="50px" >
            <td align="center"><br>
            <font size="5" face="Lucida Console" color=blue ><strong> Search Sell Record 
           </td>
        </tr>
        <tr align="center"><td><br>
        <input type="text" name="searchdata" id="search" size="40" onkeyup="fetchuser()">
        <br><br>
        <input type="submit" class="button" name="searchid" value="By Product ID">
...
$mydb=new DB();
$conobj=$mydb->opencon();
$mydata=$mydb->SearchID("sellrecord",$conobj,$sdata);
if($mydata->num_rows> 0)
{
    ...
    while($row=$mydata->fetch_assoc())
    {
       ...
       echo "<tr><td>Product Name :".$row["name"]."</font></td></tr>";
...
$mydata1=$mydb1->SearchName("sellrecord",$conobj1,$_POST["searchdata"]);
...
$mydb=new DB();
$conobj=$mydb->opencon();
$mydata=$mydb->SearchCat("sellrecord",$conobj,$_POST["searchdata"]);
if($mydata->num_rows> 0)
{
