...
class DB{
    ...
    function InsertData($proname,$quan,$price,$catagory,$proid,$sid,$tablename,$conn){
        $sqlstr="INSERT INTO $tablename (proname,quantity,price,catagory,proid,sid) VALUES ('$proname',$quan,$price,'$catagory',$proid,$sid)";
