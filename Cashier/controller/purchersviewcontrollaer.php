     ...
     if(isset($_POST["search"]))
{
    ...
    $mydata=$mydb->searchpur($conobj, "purchaserecord",$_POST["sid"]);
...
if(isset($_POST["update"]))
{
    $mydb=new DB();
    $conobj=$mydb->opencon();
    $mydb->updatespur("purchaserecord",$_POST["proname"],$_POST["CATAGORY"],$_POST["Quantity"],$_POST["price"],$_POST["PRODUCT"],$_POST["sid"],$conobj);
...
if(isset($_POST["delete"]))
{
    ...
    $mydb=new DB();
    $conobj=$mydb->opencon();
    $mydb->deletepur("purchaserecord",$_POST["sid"],$conobj);
