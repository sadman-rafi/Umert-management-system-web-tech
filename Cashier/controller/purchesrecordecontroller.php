...
if(isset($_POST["submit"]))
{
    ...
    $proid=$_POST["PRODUCT"];
    $sid=$_POST["sid"];
if(empty($proname) || empty($catagory) || 
empty($quantity) || empty($price)|| empty($proid)||empty($sid) )
{
...
*/
    ...
    $mydb=new DB();
    $conobj=$mydb->opencon();
    $mydb->purchaserecord($proname,$catagory,$quantity,$price,$proid,$sid,"purchaserecord",$conobj);
